Scriptable Render Pipeline assets in LB require Unity 2019.4.1f1 or newer.
...
2. If using HDRP, from package manager, import High Definition Render Pipeline 7.3.1 (U2019.4 LTS+)
3. If using URP, from package manager, import Universal Render Pipeline 7.3.1 (U2019.4 LTS+)
